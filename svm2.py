...
if 1>0:
	...
	#print(path.join(dirname, r'libsvm-3.20/libsvm.so.2'))
	print(dirname)
	print("-------------------------")
	print(sys.platform)
	#print(path.join(dirname, r'libsvm-3.20\windows\libsvm.dll'))
	if sys.platform == 'win32':
		print(path.join(dirname, r'libsvm-3.20\\windows\\libsvm.dll'))
		print(os.path.isfile(path.join(dirname, r'libsvm-3.20\\windows\\libsvm.dll')))
		libsvm = CDLL(path.join(dirname, r'libsvm-3.20\\windows\\libsvm.dll'))

	else:
		#print(path.join(dirname, r'libsvm-3.20/libsvm.so.2'))
		libsvm = CDLL(path.join(dirname, r'libsvm-3.20/libsvm.so.2'))
		#print("success")
else:
